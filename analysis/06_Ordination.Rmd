...
```{r scale-reads, fig.width=3, fig.height=3}
min(sample_sums(archaeal_rooted_physeq))
...
<span style="color: red;">INTERPRETATION #3:  Evaluating the range of the scaled read counts (and the histogram above), what did you scale the read counts to in your dataset? Why did you choose that number? Do you think it is sufficient to perform a beta-diversity analysis and accurately compare your data to one another?</span>
...
<span style="color: red;">INTERPRETATION #6: Using the above example to guide you, run the appropriate PERMANOVA for your scientific question and interpret the results. What biological conclusion can you draw from your PERAMNOVA results?</span>
...
<span style="color: red;">INTERPRETATION #7: Using the above example to guide you, run the appropriate betadisper() and permutest() for your scientific question and interpret the results. What biological conclusion can you draw from your dispersion analysis?</span>

<span style="color: red;">INTERPRETATION #8: Taking into account both the betadisper()/permutest() and the PERMANOVA (adonis2()) test that you ran, what biological conclusion can you draw regarding your data?</span>
...
<span style="color: red;">INTERPRETATION #9: Plot your data using a PCoA. Interpret what you can conclude from the PCoA.</span>
...
<span style="color: red;">INTERPRETATION #10: Plot your data using NMDS. Interpret what you can conclude from the NMDS.</span>
...
<span style="color: red;">INTERPRETATION #11: Plot both the PCoA and NMDS together. Which of the two visualizations work best for your data? Explain your reasoning.</span>
