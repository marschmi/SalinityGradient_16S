...
<span style="color: red;">INTERPRETATION #1: Are there any suspect branches in your tree? Or does your tree look "clean"? Why or why not?</span>
...
mrca_node_703 <- MRCA(unrooted_tree, .node1 = 703, .node2 = 702) #3315
...
In the subtree above, it's clear that 1910 is longer than the nearby branches. Let's inspect some more! 

```{r pull-node1910}
# lets look at the long branch
mrca_node_1910 <- MRCA(unrooted_tree, .node1 = 1910, .node2 = 1909) #3315
...
- There are VERY FEW counts! Only a total of 5 counts across two samples. A very rare microbe!
- But this time, we have the taxonomy assigned to the Order level: a Burkholderiales and a Chlamydiales. 
...
If you're working in QIIME or another microbiome pipeline and don't have a clear outgroup, midpoint rooting is typically fine — especially for things like UniFrac or beta diversity. If you’re doing evolutionary or taxonomic analysis and have a suitable outgroup, use that instead.
